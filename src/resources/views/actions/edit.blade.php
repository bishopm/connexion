...
@section('content')
    {!! Form::open(['route' => ['admin.todo.action.update', $action->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('todo::admin.actions.partials.edit-fields', ['lang' => $locale])
                            @tags('todo_action_context',$action,'todo::admin.fields.tags')
                        </div>
                    @endforeach
