...
Route::get('/api/individual/{id}', ['uses' => 'Bishopm\Connexion\Http\Controllers\IndividualsController@api_individual','as' => 'api.individual']);	
Route::middleware(['handlecors'])->group(function () {
	...
	Route::group(['middleware' => ['jwt.refresh','handlecors']], function () {
		Route::get('/api/refresh',['uses'=>'Bishopm\Connexion\Http\Controllers\Auth\ApiAuthController@refreshToken','as'=>'api.refresh']);
	});
