...
Once you are logged in, take a moment to explore user menu in the top right hand corner of the site. Go and visit your user profile page, where you can upload a pic (and include a short bio if you like). The My {{$setting['site_abbreviation']}} link below gives you a look at the other users on the system. 
