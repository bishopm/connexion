...
use Bishopm\Connexion\Models\Individual, Bishopm\Connexion\Models\Household, Bishopm\Connexion\Models\Specialday;
use Bishopm\Connexion\Models\Setting, Bishopm\Connexion\Models\Group, DB;
...
class BirthdayEmail extends Command
{
    ...
    public function handle()
    {
        ...
        //DB::enableQueryLog();
        $birthdays=Individual::join('households', 'household_id', '=', 'households.id')->select('individuals.id','homephone','householdcell','cellphone','firstname','surname',DB::raw('substr(birthdate, 6, 5) as bd'))->wherein(DB::raw('substr(birthdate, 6, 5)'),$days)->orderBy(DB::raw('substr(birthdate, 6, 5)'))->get();
