...
class ConnexionServiceProvider extends ServiceProvider
{
    ...
    private function initialiseSettings()
    {
        $settings=array(
            ...
            ['setting_key'=>'circuit_stewards','module'=>'mcsa','description'=>'Circuit Stewards (comma separated)','setting_value'=>''],
            ...
            ['setting_key'=>'local_preachers_secretary','module'=>'mcsa','description'=>'Local Preachers Secretary','setting_value'=>''],
